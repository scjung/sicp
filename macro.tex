...
\lstset{
  ...
  commentstyle=\it\color[gray]{0.3},
  numbers=left,
  numberstyle=\tiny,
  numbersep=10pt,
}
...
\newcommand{\scheme}[1]{\lstinputlisting[language=Scheme]{#1}}
\newcommand{\schemepart}[3]{
\lstinputlisting[language=Scheme,firstline=#2,lastline=#3]{#1}
}
\newcommand{\schemefrom}[2]{
\lstinputlisting[language=Scheme,firstline=#2]{#1}
}
\newcommand{\ocaml}[1]{\lstinputlisting[language={[Objective]Caml}]{#1}}
\newcommand{\ocamlpart}[3]{
\lstinputlisting[language={[Objective]Caml},firstline=#2,lastline=#3]{#1}
}
\newcommand{\ocamlfrom}[2]{
\lstinputlisting[language={[Objective]Caml},firstline=#2]{#1}
}
}
{}
\makeatother
